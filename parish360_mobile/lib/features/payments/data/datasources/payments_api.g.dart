...
class _PaymentsApi implements PaymentsApi {
  ...
  Future<List<PaymentInfo>> getPayments() async {
    ...
    final _options = _setStreamType<List<PaymentInfo>>(
    ...
    late List<PaymentInfo> _value;
    try {
      _value = _result.data!
          .map((dynamic i) => PaymentInfo.fromJson(i as Map<String, dynamic>))
          .toList();
    } on Object catch (e, s) {
  ...
  Future<PaymentInfo> getPaymentInfo(String paymentId) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<PaymentInfo>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/payments/${paymentId}',
    ...
    late PaymentInfo _value;
    try {
      _value = PaymentInfo.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  Future<Uint8List> createPayment(PaymentInfo paymentInfo) async {
    ...
    _data.addAll(paymentInfo.toJson());
