...
class AssociationAssociateList extends ConsumerWidget {
  final List<AssociationInfo> associations;

  const AssociationAssociateList({super.key, required this.associations});
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Column(
                                ...
                                children: [
                                  StatusTag(
                                    status: association.active.toString(),
                                    child: Text(association.active.toString()),
                                  ),
                                ],
                              ),
                            ],
