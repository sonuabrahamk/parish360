...
class _ParishYearAssociationsScreenState
  ...
  Widget build(BuildContext context) {
    ...
    final pyAssociationsAsync = ref.watch(
      pyAssociationListControllerProvider(_parishYearIdController.text),
    );

    return parishYearListAsync.when(
      data: (parishYearList) {
        if (parishYearList.isEmpty) {
          return Center(child: Text('No Parish year data found'));
        }
        ...
        return pyAssociationsAsync.when(
              ...
              children: [
                pyAssociations.isEmpty
                    ...
                    : ListTitle(
                        module: 'parish',
                        subTitle:
                            'Showing ${pyAssociations.length} associations',
                        title: 'Associations',
                        onCreatePressed: () {},
                      ),
          ...
          error: (e, st) => Center(
            child: Text(
              'Error loading associations for the provided parish year ${_parishYearIdController.text}',
            ),
          ),
        );
      },
