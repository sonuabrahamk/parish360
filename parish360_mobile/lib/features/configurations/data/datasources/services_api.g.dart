...
class _ServicesApi implements ServicesApi {
  ...
  Future<List<ServiceInfo>> getAllServices() async {
    ...
    final _options = _setStreamType<List<ServiceInfo>>(
    ...
    late List<ServiceInfo> _value;
    try {
      _value = _result.data!
          .map((dynamic i) => ServiceInfo.fromJson(i as Map<String, dynamic>))
          .toList();
    } on Object catch (e, s) {
  ...
  Future<ServiceInfo> createService(ServiceInfo serviceInfo) async {
    ...
    _data.addAll(serviceInfo.toJson());
    final _options = _setStreamType<ServiceInfo>(
    ...
    late ServiceInfo _value;
    try {
      _value = ServiceInfo.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
