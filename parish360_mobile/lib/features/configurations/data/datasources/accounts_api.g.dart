...
class _AccountsApi implements AccountsApi {
  _AccountsApi(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<List<AccountInfo>> getAllAccounts() async {
    ...
    final _options = _setStreamType<List<AccountInfo>>(
    ...
    late List<AccountInfo> _value;
    try {
      _value = _result.data!
          .map((dynamic i) => AccountInfo.fromJson(i as Map<String, dynamic>))
          .toList();
    } on Object catch (e, s) {
  ...
  @override
  Future<AccountInfo> createAccount(AccountInfo accountInfo) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(accountInfo.toJson());
